...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><<!-- 这是jstl标签，c标签库  如<c:if test="${not empty message}">-->
<%@ taglib prefix="shiro" uri="http://shiro.apache.org/tags" %><!-- 这个未知库，应该springside4的新库，我没用过，可以网上查一下，要用要下载一个jar包就可以了 -->
<%@ taglib prefix="s" uri="/struts-tags"%> <!-- 这是struts2标签库 -->
